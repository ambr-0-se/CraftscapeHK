...
// Clean runtime constants for seeding (mirror of constants.ts)
...
const CRAFTS = [
  {
    ...
    full_description: {
      zh: "廣彩，全稱「廣州織金彩瓷」，是清代以來在廣州地區發展起來的釉上彩繪瓷器工藝。它以色彩絢麗、構圖飽滿、金碧輝煌著稱，是東西方文化交融的結晶。",
    ...
    history: {
      ...
      en: "Canton Porcelain originated in the late Kangxi period of the Qing Dynasty and flourished during the Yongzheng and Qianlong eras. At that time, Guangzhou was the sole port for foreign trade. White porcelain bodies from Jingdezhen were shipped here, painted according to foreign orders, and then exported, becoming highly popular in Europe."
    },
    story: {
      zh: "張師傅是廣彩世家的第三代傳人。他的祖父曾在廣州十三行開設瓷器作坊。張師傅從小耳濡μ染，不僅繼承了傳統技法，更嘗試將現代設計元素融入創作，希望這門古老手藝能被更多年輕人喜愛。",
      en: "Master Zhang is the third-generation heir of a Canton Porcelain family. His grandfather once ran a porcelain workshop in the Thirteen Factories of Canton. Master Zhang, immersed in this art from a young age, has not only inherited traditional techniques but also tries to integrate modern design elements into his creations, hoping this ancient craft will be appreciated by more young people."
    }
  },
  {
    id: 2,
...
module.exports = { CRAFTS, ARTISANS, PRODUCTS, EVENTS, ORDERS, MESSAGE_THREADS, GLYPH_LIBRARY };
